...
/***/ "./dist/esm/ExpoSQLiteAdapter/ExpoSQLiteDatabase.mjs":
/*!***********************************************************!*\
  !*** ./dist/esm/ExpoSQLiteAdapter/ExpoSQLiteDatabase.mjs ***!
  \***********************************************************/
...
/* harmony export */   "default": () => (/* binding */ ExpoSQLiteDatabase)
/* harmony export */ });
...
/* harmony import */ var _common_constants_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../common/constants.mjs */ "./dist/esm/common/constants.mjs");
...
const logger = new _aws_amplify_core__WEBPACK_IMPORTED_MODULE_0__.ConsoleLogger('ExpoSQLiteDatabase');
/*
...
class ExpoSQLiteDatabase {
    async init() {
        ...
        if (!this.db) {
            ...
            this.db = (0,expo_sqlite__WEBPACK_IMPORTED_MODULE_2__.openDatabase)(_common_constants_mjs__WEBPACK_IMPORTED_MODULE_3__.DB_NAME);
        }
    }
    ...
    async clear() {
        try {
            ...
            await (0,expo_file_system__WEBPACK_IMPORTED_MODULE_1__.deleteAsync)(`${expo_file_system__WEBPACK_IMPORTED_MODULE_1__.documentDirectory}SQLite/${_common_constants_mjs__WEBPACK_IMPORTED_MODULE_3__.DB_NAME}`);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ExpoSQLiteAdapter)
/* harmony export */ });
...
/* harmony import */ var _ExpoSQLiteDatabase_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ExpoSQLiteDatabase.mjs */ "./dist/esm/ExpoSQLiteAdapter/ExpoSQLiteDatabase.mjs");



// Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
// SPDX-License-Identifier: Apache-2.0
const ExpoSQLiteAdapter = new _common_CommonSQLiteAdapter_mjs__WEBPACK_IMPORTED_MODULE_0__.CommonSQLiteAdapter(new _ExpoSQLiteDatabase_mjs__WEBPACK_IMPORTED_MODULE_1__["default"]());
